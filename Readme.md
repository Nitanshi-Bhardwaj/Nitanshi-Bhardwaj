...
I'm Nitanshi Bhardwaj, an MS student in Data Science at Columbia University, focused on building intelligent AI/ML systems.

- **Building end-to-end AI/ML systems** combining data science + machine learning + GenAI, from exploratory analysis to production deployment.
- **Interested in Generative AI & LLMs** for intelligent automation, RAG systems, agentic AI, and real-world NLP applications.
- **DSI Research Scholar & Teaching Assistant** — Ethical and Responsible AI: supporting coursework, research, and bridging theory with practical AI applications.
- **Hands-on with Python, SQL, PyTorch/TensorFlow, scikit-learn, FAISS, AWS (EC2/SageMaker), OpenCV, and Power BI** for ML/AI, data analysis, and cloud deployment.
- **Research experience** (IIT Kanpur) with published work in **IEEE** and **Springer** on assistive technology and explainable AI.
...
**ML/AI:** PyTorch • TensorFlow • scikit-learn • XGBoost • OpenCV • MediaPipe
**GenAI & LLMs:** RAG • FAISS • Sentence Transformers • Prompt Engineering • Agentic AI
**Data Science:** Pandas • NumPy • EDA • Feature Engineering • Hypothesis Testing
**Visualization:** Power BI • Tableau • Matplotlib • Seaborn
**Cloud & Tools:** AWS (EC2, SageMaker) • Git/GitHub • REST APIs
...
- **Impact:** Improved pricing strategy accuracy for business decisions
...
- Developed AI-powered multi-modal interface (gesture + voice control) for mobility-impaired users
- Published in **IEEE journal** and presented at International Conference on Computing & Data Science

### **The Disagreement Dilemma in Explainable AI** | Springer Published
*LIME • ALE • SHAP • Fairness Analysis*
- Analyzed disagreement in post-hoc XAI methods across datasets
- Published in **Springer** academic journal
...
**AI/ML Intern** | AICTE | *Jan 2024 – Mar 2024*
Deployed ML models on AWS (EC2, SageMaker) • Reduced training runtime by 15%

**Data Science Intern** | Orbitor, Codsoft | *2023*
Built NLP spam classifier (98% accuracy) • Fraud detection model (AUC 0.95) • CNN image classifier (91% accuracy)
...
**BTech in Artificial Intelligence** | S.R.M Institute of Science and Technology | CGPA: 9.02/10.00 | *2021-2025*
...
*MS in Data Science @ Columbia University | Building intelligent systems with AI/ML*
